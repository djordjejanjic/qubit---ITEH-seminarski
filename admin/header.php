        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="index.html"> <i class="menu-icon fa fa-dashboard"></i>Kontrolna tabla</a>
                        ...
                        <a href="index.html"> <i class="menu-icon fa fa-close"></i>Izloguj se</a>
                    </li>
